...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["repository_id"],
            ["repositories.id"],
            name=op.f("fk_indexed_documents_repository_id_repositories"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_indexed_documents")),
    )
    op.create_index(
        op.f("ix_indexed_documents_id"), "indexed_documents", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_indexed_documents_qdrant_point_id"),
        "indexed_documents",
        ["qdrant_point_id"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "RUNNING", "COMPLETED", "FAILED", name="review_status"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "RUNNING", "COMPLETED", "FAILED", name="agent_status"),
            nullable=False,
        ),
        sa.Column("execution_time_ms", sa.Integer(), nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ["review_id"],
            ["reviews.id"],
            name=op.f("fk_agent_runs_review_id_reviews"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum("CRITICAL", "HIGH", "MEDIUM", "LOW", "INFO", name="severity_level"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_review_findings_id"), "review_findings", ["id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_indexed_documents_qdrant_point_id"), table_name="indexed_documents"
    )
