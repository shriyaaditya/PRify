...
from app.rag.models import DocumentChunk, DocumentMetadata, RetrievedContext
...
class QdrantVectorStore:
    ...
    async def delete_document_chunks(
        self, collection_name: str, repository: str, document_name: str
    ):
        """
                ...
                filter=qmodels.Filter(
                    must=[
                        qmodels.FieldCondition(
                            key="repository", match=qmodels.MatchValue(value=repository)
                        ),
                        qmodels.FieldCondition(
                            key="document",
            ...
            query_filter=qmodels.Filter(
                must=[
                    qmodels.FieldCondition(
                        ...
                        match=qmodels.MatchValue(value=repository),
                    )
                ]
            ),
        )
