...
class SemgrepFinding(BaseModel):
    ...
    """
    rule_id: str = Field(description="Semgrep rule identifier (e.g. python.lang.security.audit.sqli)")
    file_path: str = Field(description="Relative path of the file where the finding occurred")
    ...
    code_snippet: Optional[str] = Field(default=None, description="Triggering code snippet")
